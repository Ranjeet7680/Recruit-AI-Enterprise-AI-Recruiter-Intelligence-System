...
import { CalendarPlus, UserPlus, Sparkles, ArrowLeft } from 'lucide-react';
      ...
      >
        <div>
          <div className="flex items-center gap-2 mb-2">
            <Link href="/" className="inline-flex items-center gap-1.5 text-xs text-indigo-400 hover:text-indigo-300 font-semibold transition-colors">
